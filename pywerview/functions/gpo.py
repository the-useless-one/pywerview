                ...
                for gplink in gplinks:
                    ...
                    for gpo_group in gpo_groups:
                        for member in gpo_group.members:
                            ...
                            gpo_computer_admin.add_attributes({'isgroup' : ('USER_OBJECT' not in obj.samaccounttype)})
                            ...
                            if recurse and gpo_computer_admin.isgroup:
                                ...
                                while groups_to_resolve:
                                    ...
                                    for group_member in group_members:
                                        ...
                                        gpo_computer_admin.add_attributes({'isgroup' : ('USER_OBJECT' not in group_member.samaccounttype)})
